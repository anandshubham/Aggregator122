...
module Fluent
  class TransformFilter < Filter
    Fluent::Plugin.register_filter('transform', self)
    ...
    desc 'Forces null value on the given fields'
    config_param :force_null, :array, :default => []
    ...
    def filter_stream(tag, es)
      ...
      es.each do |time, record|
        ...
        force_null.each do |field|
            if new_record.has_key?(field) && new_record[field] == ""
                new_record[field] = nil
            end
        end
